...
declare var d3: any;
@Component({
  selector: 'app-meter-guage',
  templateUrl: './meter-guage.component.html',
  styleUrls: ['./meter-guage.component.css']
})
export class MeterGuageComponent implements OnInit {
  ...
  var barWidth, chart, chartInset, degToRad, repaintGauge,
      ...
      percent, radius, sectionPerc, sectionIndx, svg, totalPercent, width;
