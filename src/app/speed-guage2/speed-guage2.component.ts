...
declare var d3: any;
@Component({
  selector: 'app-speed-guage2',
  templateUrl: './speed-guage2.component.html',
  styleUrls: ['./speed-guage2.component.css']
})
export class SpeedGuage2Component implements OnInit {
  gaugemap = {};
  constructor() { }
    ngOnInit() {
    this.draw();
